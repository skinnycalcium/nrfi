...
Email body includes EVERY game on the slate with a clear verdict.
Full HTML dashboard attached.
"""
...
VERDICT_RANK = {"BET NRFI": 0, "BET YRFI": 0, "NO BET": 1, "NO LINE": 2}
    ...
    for g in games:
        ...
        rows.append(f"""
          <tr style="border-bottom:1px solid #eee;">
            <td style="padding:8px;"><strong style="color:{color};font-size:10px;letter-spacing:0.1em;">{label}</strong></td>
            <td style="padding:8px;font-size:12px;">{g.away_team} @ {g.home_team}</td>
            <td style="padding:8px;font-family:monospace;font-size:12px;text-align:right;color:#15803d;">{g.p_nrfi*100:.0f}%</td>
            <td style="padding:8px;font-family:monospace;font-size:12px;text-align:right;color:#1d4ed8;">{g.p_yrfi*100:.0f}%</td>
            <td style="padding:8px;font-family:monospace;font-size:12px;text-align:right;">{line_str}</td>
            <td style="padding:8px;font-family:monospace;font-size:12px;text-align:right;color:{color};"><strong>{edge_str}</strong></td>
            <td style="padding:8px;font-family:monospace;font-size:12px;text-align:right;">{stake_str}</td>
          </tr>
        """)
        ...
        f"""<table style="width:100%;border-collapse:collapse;margin-top:8px;">
          <thead>
            <tr style="border-bottom:2px solid #0a0a0a;text-align:left;">
              ...
              <th style="padding:8px;font-size:9px;letter-spacing:0.15em;color:#666;">MATCHUP</th>
...
<div style="max-width:780px;margin:0 auto;background:white;border:1px solid #e5e5e5;padding:32px;">
  ...
  <p style="color:#666;font-size:13px;margin:12px 0 24px;">
    <strong style="color:#15803d;">{bn} bet NRFI</strong> · 
    <strong style="color:#1d4ed8;">{by} bet YRFI</strong> · 
    <span style="color:#999;">{nb} no bet · {nl} no line</span> · 
